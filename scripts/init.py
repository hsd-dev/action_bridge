...
def generate_cpp(output_path, template_dir):
    ...
    for ros2_package_name in data['ros2_package_names']:
        ...
        interface_type, interfaces = zip(
            ['msg', 'srv'], [data['all_ros2_msgs'], data['all_ros2_srvs']]
        )
        # print(interface_type[1][1])
...
class Mapping:
    ...
    def __repr__(self):
        # + " " + str(self.fields_1_to_2) + " " + str(self.fields_2_to_1) + " " + str(self.depends_on_ros2_messages)
        return self.ros1_msg.message_name + ", " + self.ros2_msg.message_name
